...
test(
  'hasRequiredProjects should return false when projects has not required projects',
  (t) => {
    const project = {
      _id: '5ba0f2a2b41162092b59d900',
      title: 'project 2b',
...
test(
  'hasRequiredProjects should throw error when project has not requires property',
  (t) => {
    const project = {
      _id: '5ba0f2a2b41162092b59d900',
      title: 'project 2b',
    ...
    t.is(
      error.message,
      'project object has not requires property',
    );
  },
);
